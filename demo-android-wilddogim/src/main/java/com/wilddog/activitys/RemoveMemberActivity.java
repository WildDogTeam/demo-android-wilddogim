...
public class RemoveMemberActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        addGroupMemberAdapter = new AddGroupMemberAdapter(RemoveMemberActivity.this, friendlists);
    ...
    private void getMemberList() {
        ...
        if (lUsers.size() < 1) {
            AlertMessageUtil.showShortToast("至少需要一个删除成员");
            return;
        } else {
            // 邀请 群成员
            conversation.removeMember(lUsers);
            finish();
        }
